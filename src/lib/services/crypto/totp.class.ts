...
export class TotpClass {
     ...
     * @param tDelta       The unix time intervals for which a single token is valid (defaults to 30 seconds)
     *
     * @returns {Observable<string>}
     */
	private computeTotpToken( tStart: number = 0, tDelta: number = 30 ): Observable<string> {
     ...
     * @param {Uint8Array} key              (Optional) The key to use for the hmac. When not provided the member visible key ("_totpKey") will be used
