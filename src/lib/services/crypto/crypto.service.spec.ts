...
describe( 'CryptoService', () => {
	...
	let communicationParameter: MumblerParameter = null;
	...
	beforeAll( ( done: DoneFn ) => {
	    ...
	    factory( appService ).subscribe( ( config: MumblerParameter ) => {
	...
	beforeEach( () => {
		...
		TestBed.configureTestingModule( {
			providers: [
				{
					provide: mumblerParameterInjectionToken,
					deps: [
						AppService
					],
